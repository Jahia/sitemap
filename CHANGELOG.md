...
* BACKLOG-15584: Initial commit based on add\_integration\_tests branch. [#17](https://github.com/Jahia/sitemap/pull/17) ([@XiangYuHe](https://github.com/XiangYuHe))
...
* \[maven-release-plugin] prepare release 3\_0\_1 ([@fbourasse](https://github.com/fbourasse))
